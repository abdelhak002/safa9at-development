...
// 25-11-2020 trades
Route::resource('trade', 'TradeController')->middleware('auth')->middleware('CheckCurrencies');
...
Route::post('trade/fetch', 'TradeController@fetch')->name('trade.fetch')->middleware('auth');
