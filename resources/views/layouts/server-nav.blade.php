                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mr-auto" >
                         <li class="nav-item active">
                            <a class="nav-link" href="{{ url('server/service') }}">{{ __('server.myServices') }} <span class="sr-only">(current)</span></a>
                         </li>

                         <li class="nav-item active">
                            <a class="nav-link" href="{{ url('server/payment') }}">{{ __('server.payments') }}<span class="sr-only">(current)</span></a>
                         </li>

                         <li class="nav-item active">
                            <a class="nav-link" href="{{ url('server/earning') }}">{{ __('server.earnings') }}<span class="sr-only">(current)</span></a>
                         </li>
