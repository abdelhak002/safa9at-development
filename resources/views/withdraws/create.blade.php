 ...
 $('.dynamic').change(function(){
  if($(this).val() != '')
  {
   ...
   if(value == 'paypal'){
		...
		document.getElementById('paymentInfo').placeholder ='exmaple@gmail.com';
		...
		document.getElementById('changePaymentInfo').innerHTML ='Account number';
		document.getElementById('paymentInfo').type = 'text';
		document.getElementById('paymentInfo').placeholder ='U87654321';
