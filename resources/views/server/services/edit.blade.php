...
<form method="POST" action="{{ url('server/service/'. $service->id) }}" enctype="multipart/form-data">
	...
	<div class="pt-1 pl-3 pr-3">
		<label for="sub_category"><h5 class="font-weight-bold">{{ __('server.serviceSubCategory') }}</h5></label>
	...
	<div class="pt-1 pl-3 pr-3">
		<label for="price"><h5 class="font-weight-bold">{{ __('server.price') }}</h5></label>
	...
	<div class="pt-1 pl-3 pr-3">
		<label for="status"><h5 class="font-weight-bold">{{ __('server.service_status') }}</h5></label>
	...
	<div class="pt-1 pl-3 pr-3">
		<label for="Description"><h5 class="font-weight-bold">{{ __('server.service_description') }}</h5></label>
	...
	<button class="btn btn-primary float-right" type="submit">{{ __('server.save') }}</button>
</form>
</div>
