 ...
 $('.dynamic').change(function(){
  if($(this).val() != '')
  {
   ...
   if(value == 'ccp'){
	...
	if(value == 'paypal' || value == 'paysera'){
		document.getElementById('changePaymentInfo').innerHTML ='Transaction NO';
	}else if(value == 'skrill' || value == 'payeer'){
		document.getElementById('changePaymentInfo').innerHTML ='Transaction ID';
	}else if(value == 'perfectmoney'){
		document.getElementById('changePaymentInfo').innerHTML ='Transaction ID (Batch)';
	}
  }
 });
