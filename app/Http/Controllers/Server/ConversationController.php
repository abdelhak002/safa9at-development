...
class ConversationController extends Controller
{
    ...
    public function show($id){
        ...
        $payment_methods = PaymentMethod::where('status','on')->get();
        ...
        return view('server.conversation.conversation', ['messages' => $messages, 'conversation' => $conversation, 'service' => $service, 'payment' => $payment, 'balance' => $balance ,'hold_balance' => $hold_balance, 'offer' => $offer, 'payment_methods' => $payment_methods, 'currencies' => $currencies, 'user_id' => $user_id, 'offers_price' => $offers_price]);
    }
