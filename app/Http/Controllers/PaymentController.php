...
class PaymentController extends Controller
{
	...
	public function store(paymentRequest $request){
		...
		$this->createNotification(Auth::id(),'paymentCreated','','conversation/'.$payment->id);
		$this->createNotification($service->creator_id,'youGotNewOrder','','server/conversation/'.$payment->id);
